public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(new ValidaCPF("").cpfFormat("182.334.377-51"));
        System.out.println(Pessoa.numPessoas());
        Pessoa a = new Pessoa("joao", "vitor", 25,5,2003,18233437751l, 75f,
                1.73f);
        ...
        Homem c = new Homem("joao", "vitor", 26,7,1960,18233437751l, 75f,
                1.73f);
